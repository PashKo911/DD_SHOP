...
import StyleRadioGroup from '@/components/features/catalog/filters/StyleRadioGroup.vue'
import SliderPrice from '@/components/features/catalog/filters/SliderPrice.vue'
