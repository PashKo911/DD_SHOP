<template>
	<section
		class="bg-primary px-md-84-15 py-md-57-15 gy-lg-50-30 container flex flex-col items-start justify-between gap-x-4 md:w-[95%] md:flex-row md:rounded-2xl xl:w-full"
	>
		<h2
