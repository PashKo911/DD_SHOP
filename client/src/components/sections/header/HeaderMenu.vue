...
import { getMenuItems } from '@/utils/routing/getMenuItems'
...
import MainSearchInput from '@/components/features/search/MainSearchInput.vue'
import UserControl from '@/components/shared/userControl/UserControl.vue'
