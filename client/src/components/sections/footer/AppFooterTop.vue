<template>
	<div class="my-100-30 container items-start justify-between gap-8 lg:flex">
		<div class="gy-40-25 grid grow max-lg:mb-10">
...
<script setup>
import SocialList from '@/components/shared/social/SocialList.vue'
